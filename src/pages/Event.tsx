...
const Event = () => {
  ...
  return (
    <div className="flex flex-col gap-4 min-h-screen">
      <div className="py-2 w-full sticky mt-20 top-16 z-20  bg-white">
        <div className="flex items-center justify-between gap-4">
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              />
              <h4 className="text-start font-semibold text-lg">Date</h4>
              <div className="flex flex-col items-center gap-4">
                <DateTimeSection
                  title="Start date"
                  date={draftFilterDate.startDate}
                  dateField="eventStartDate"
                  updateField={updateField}
                />
                <DateTimeSection
                  title="End date"
                  date={draftFilterDate.endDate}
